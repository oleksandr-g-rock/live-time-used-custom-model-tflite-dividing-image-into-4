  ...
  with picamera.PiCamera(resolution=(640, 480), framerate=30) as camera:
    ...
    try:
      ...
      for _ in camera.capture_continuous(
        ...
        #print predict classes
        classes = np.argmax(output_data, axis = 1)
        print("IMAGE L2.", " , predict class number: ", classes, " ,is class name: ", classes_names[classes[0]], sep='') ###NEED CHANGE 
        #block for print result
        ...
        #print predict classes
        classes = np.argmax(output_data, axis = 1)
        print("IMAGE L1.", " , predict class number: ", classes, " ,is class name: ", classes_names[classes[0]], sep='')
        #block for print result


        ##############################################################################################PREDICT R3 ###NEED CHANGE 
        # dsize
        dsize = (299, 299)
        # resize image
        ...
        #print predict classes
        classes = np.argmax(output_data, axis = 1)
        print("IMAGE R3.", " , predict class number: ", classes, " ,is class name: ", classes_names[classes[0]], sep='') ###NEED CHANGE 
        #block for print result
