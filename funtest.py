...
l1 = cv2.rotate(l1, cv2.ROTATE_90_COUNTERCLOCKWISE) #image1 ###NEED CHANGE 
####################################BLOCK FOR IMAGE DIVIDING FINISH#############################



##############################################################################################PREDICT L1 ###NEED CHANGE 
# dsize
dsize = (299, 299)
# resize image
...
print("IMAGE L1.", " , predict class number: ", classes, " ,is class name: ", classes_names[classes[0]], sep='') ###NEED CHANGE 
